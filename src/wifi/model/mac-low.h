...
public:
  ...
  //TODO: Ratnesh: Send a CTS to self for LAA
  virtual void StartLaaCtsToSelfTx (Time duration);
...
private:
  ...
  bool m_laawifi;  //!< Flag if the device is wifi listener for LAA

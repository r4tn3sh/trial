...
private:
  ...
  ChannelSenseMode_t m_channelSenseMode;
  LbtState m_state;
  Time m_slotTime;
  Time m_deferTime;
  uint32_t m_cwMin;
  ...
  EventId m_waitForCtsEventId;
  Time m_lastCWUpdateTime;
  Time m_backoffStartTime;
  Time m_lastBusyTime;
  Time m_lastReqStartTime;  //!< XXX: Ratnesh
